window.lmaolmao = {
    ...
    "detectConflictsUntil": null, "iconUploads": {},
    "id": 2262095,
    "license": "free",
    "method": "css",
    "minify": { "enabled": true },
    ...
    function () {
        ...
        function n(t, e) {
            var n = Object.keys(t); if (Object.getOwnPropertySymbols) {
                var o = Object.getOwnPropertySymbols(t); e && (o = o.filter((function (e) {
        ...
        function o(t) {
            for (
                ...
                o % 2 ? n(Object(r), !0).forEach((
                    function (n) {
                        e(t, n, r[n])
                    })
                ) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(r)) : n(Object(r)).forEach((
                    function (e) {
        ...
        function r(t, e) {
            return function (t) {
                ...
                if (
                    "undefined" == typeof Symbol || !(Symbol.iterator in Object(t))) return;
                var n = [],
                    o = !0,
                    r = !1,
                    i = void 0;
                try {
                    for (
                        var c,
                        a = t[Symbol.iterator]();
                        !(o = (c = a.next()).done) && (n.push(c.value), !e || n.length !== e); o = !0);
                }
                catch (t) {
                    r = !0,
                        i = t
        ...
        function u(t, e) {
            var n = e || ["fa"], o = "." + Array.prototype.join.call(n, ",."),
            ...
            Array.prototype.forEach.call(r, (
                function (e) {
                    ...
                    if (n && o) {
                        ...
                        r.innerHTML = n, r.classList.add("sr-only"),
        ...
        E.prototype = {
                ...
                return new E((
                    function (e, n) {
                        ...
                        function i(t) {
                            ...
                            c = t[a]) && "function" == typeof c.then ? c.then(i(a),
                                n
                            ) : o[a] = c; r || e(o)
                    }))
            },
            ...
            E.resolve = function (e) {
                return e && "object" === t(e) && e.constructor === E ? e : new E((
                    function (t) {
                        t(e)
                    }))
            },
                            ...
                            n(i, {
                                ...
                                function (t) {
                                    if (t.ok)
                                        return t.text();
                                    throw new Error("")
                                })).then((function (e) { t(e) })).catch(e);
                        else if (
                            "function" == typeof o
                        ) {
                            var r = new o;
                            r.addEventListener("loadend", (
                                function () { this.responseText ? t(this.responseText) : e(new Error("")) }));
                            ["abort", "error", "timeout"].map((
                                function (t) {
                                ...
                                e).then((
                                    function (i) {
                                        r(U(i, o(o({}, e), {}, {
                                            baseUrl: t.baseUrl,
                                            version: t.version,
                                            id: n.id, contentFilter: function (t, e) {
        ...
        function U(t, e) {
            ...
            return o.appendChild(r),
                ...
                e && e.detectingConflicts && e.detectionIgnoreAttr && o.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)), o
        }
        function k(t, e) {
            ...
            var n = [];
            return t.v4shim.enabled && n.push(new _((
                function (n, r) {
                    F(c(t, {
                        addOn: "-v4-shims",
                        minify: t.minify.enabled
                ...
                var x = window.lmaolmao,
                    ...
                    D = document.currentScript, N = D ? D.parentElement : document.head; (
                        function () {
                            ...
                            return "js" === t.method ? k(t, e) : "css" === t.method ? C(t, e, (
                                function (t) {
                                    L(t), T(t)
                                })
                            ) : void 0
                            ...
                            function (t) {
                                t.map((function (t) {
                                    try { N.insertBefore(t, D ? D.nextSibling : null) } catch (e) { N.appendChild(t) }
                                })),
                                    M.detectingConflicts && D && L((
                                        function () {
                                            ...
                                            var t = function (t, e) {
                                                var n = document.createElement("script");
                                                return e && e.detectionIgnoreAttr && n.setAttributeNode(
